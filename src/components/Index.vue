    ...
    <div class="container">
        ...
        <div class="sidebar">
            <ul id="sidebars">
                ...
                <li @click="selectItem($event, 'user')" class="active">
                    <span class="icon icon-user"></span>
                    <span class="item">用户管理</span>
                </li>
                <li @click="selectItem($event, 'group')">
                    <span class="icon icon-group"></span>
                    <span class="item">用户组管理</span>
                </li>
                <li @click="selectItem($event, 'priority')">
                ...
                <li @click="selectItem($event, 'store')">
                    <span class="icon icon-save"></span>
                    <span class="item">存储管理</span>
                </li>
                <li @click="selectItem($event, 'strategy')">
                    <span class="icon icon-tags"></span>
                    <span class="item">策略管理</span>
                </li>
                <li @click="selectItem($event, 'nodes')">
                    <span class="icon icon-magnet"></span>
                    <span class="item">节点管理</span>
                </li>
                <li @click="selectItem($event, 'backrestore')">
                ...
                <li @click="selectItem($event, 'views')">
